...
INTERFACE_LANGUAGES = {
    "English": {
        ...
        "no_crochet_pattern_title": "This image does not appear to contain a crochet pattern.",
        "no_crochet_pattern_body": "Please upload an image containing crochet instructions or a crochet chart.",
    ...
    "繁體中文": {
        ...
        "no_crochet_pattern_title": "這張圖片看起來不像鈎織圖樣。",
        "no_crochet_pattern_body": "請上傳包含鈎織文字或圖解的圖片。",
    ...
    "简体中文": {
        ...
        "no_crochet_pattern_title": "这张图片看起来不像钩织图样。",
        "no_crochet_pattern_body": "请上传包含钩织文字或图解的图片。",
    ...
    "日本語": {
        ...
        "no_crochet_pattern_title": "この画像にはかぎ針編みのパターンが含まれていないようです。",
        "no_crochet_pattern_body": "かぎ針編みの説明または編み図が含まれる画像をアップロードしてください。",
