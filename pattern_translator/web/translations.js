...
const english = {
  ...
  downloadTxt: "Download Translation TXT", feedback: "🐞 Report a Problem", feedbackHelp: "If something doesn’t look right, describe the problem and optionally attach screenshots.", feedbackAction: "Open Feedback Form",
...
const translations = {
  ...
  "zh-Hant": {
    ...
    downloadTxt: "下載文字翻譯 TXT", feedback: "🐞 回報問題", feedbackHelp: "如果翻譯看起來不太對，請描述問題，也可以附上截圖。", feedbackAction: "開啟意見表單", reading: "正在讀取圖片……", originalImage: "原始圖片", cropConfirmed: "文字辨識會使用這個已選範圍。如需修改，請點選「編輯範圍」。", cropPreviewCaption: "這個裁剪範圍會送去文字辨識",
  ...
  "zh-Hans": {
    ...
    downloadTxt: "下载文字翻译 TXT", feedback: "🐞 回报问题", feedbackHelp: "如果翻译看起来不太对，请描述问题，也可以附上截图。", feedbackAction: "打开反馈表单", reading: "正在读取图片……", originalImage: "原始图片", cropConfirmed: "文字识别会使用这个已选范围。如需修改，请点选“编辑范围”。", cropPreviewCaption: "这个裁剪范围会送去文字识别",
  ...
  ja: {
    ...
    downloadTxt: "翻訳テキストをダウンロード", feedback: "🐞 問題を報告", feedbackHelp: "翻訳が正しくないように見える場合は、問題の内容を入力し、必要に応じてスクリーンショットを添付してください。", feedbackAction: "フィードバックフォームを開く", reading: "画像を読み込んでいます……", originalImage: "元の画像", cropConfirmed: "この選択範囲が文字認識に使われます。変更する場合は「選択範囲を編集」をタップしてください。", cropPreviewCaption: "この切り抜き範囲が文字認識に送られます",
