...
const english = {
  ...
  overlay: "Overlay translation", overlayGuideTitle: "ⓘ How to read the translated image", overlayGuideBody: "Short translations appear directly on the image. When you see numbered markers such as [1] [2] [3], view the complete matching content in Line-by-line Translation below.", overlayGuideBodyReplacement: "Translations replace the source text in the image. Numbered markers such as [1] [2] [3] have complete matching translations in the appended image footer and in Line-by-line Translation below.", lines: "Line-by-line Translation", translatedLines: "Translated OCR lines", downloadPng: "Download Overlay Image PNG",
  ...
  notCrochetPattern: "This image does not appear to contain a crochet pattern. Please upload an image containing crochet instructions or a crochet chart.",
...
const translations = {
  ...
  "zh-Hant": {
    ...
    overlay: "圖片翻譯結果", overlayGuideTitle: "ⓘ 如何閱讀翻譯圖片", overlayGuideBody: "短翻譯會直接顯示在圖片上。看到 [1] [2] [3] 等編號時，請在圖片下方的「逐行翻譯」查看完整內容。", overlayGuideBodyReplacement: "翻譯會直接取代圖片中的原文。看到 [1] [2] [3] 等編號時，可在翻譯圖片新增的頁尾及下方「逐行翻譯」查看完整內容。", lines: "逐行翻譯", translatedLines: "已翻譯的文字辨識行", downloadPng: "下載翻譯圖片 PNG",
    ...
    notCrochetPattern: "這張圖片看起來不像鈎織圖樣。請上傳包含鈎織文字或圖解的圖片。",
  ...
  "zh-Hans": {
    ...
    overlay: "图片翻译结果", overlayGuideTitle: "ⓘ 如何阅读翻译图片", overlayGuideBody: "短翻译会直接显示在图片上。看到 [1] [2] [3] 等编号时，请在图片下方的“逐行翻译”查看完整内容。", overlayGuideBodyReplacement: "翻译会直接替换图片中的原文。看到 [1] [2] [3] 等编号时，可在翻译图片新增的页脚及下方“逐行翻译”查看完整内容。", lines: "逐行翻译", translatedLines: "已翻译的文字识别行", downloadPng: "下载翻译图片 PNG",
    ...
    notCrochetPattern: "这张图片看起来不像钩织图样。请上传包含钩织文字或图解的图片。",
  ...
  ja: {
    ...
    overlay: "画像上の翻訳", overlayGuideTitle: "ⓘ 翻訳画像の見方", overlayGuideBody: "短い翻訳は画像上に直接表示されます。[1] [2] [3] などの番号がある場合は、画像の下にある「行ごとの翻訳」で対応する全文を確認してください。", overlayGuideBodyReplacement: "翻訳は画像内の原文を直接置き換えます。[1] [2] [3] などの番号に対応する全文は、翻訳画像に追加されたフッターと下の「行ごとの翻訳」で確認できます。", lines: "行ごとの翻訳", translatedLines: "翻訳されたOCR行", downloadPng: "翻訳画像PNGをダウンロード",
    ...
    notCrochetPattern: "この画像にはかぎ針編みのパターンが含まれていないようです。かぎ針編みの説明または編み図が含まれる画像をアップロードしてください。",
