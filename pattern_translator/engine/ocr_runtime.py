...
_BROAD_DIAGNOSTIC_FIELDS = frozenset(
    {
        ...
        "measurement_failure",
        "required_stitch_concept_counts",
        "present_stitch_concept_counts",
        "mismatched_stitch_concept_ids",
        "required_color_change_count",
        "present_color_change_count",
        "semantic_unit_count",
        ...
        "deterministic_legacy_fallback_ran",
        "partial_validation_failure_count",
