...
APP_VERSION = "Pattern OCR Translator (Beta RC20a)"
...
if image_file is not None:
    ...
    if area_mode == "Whole Pattern":
        ...
        if is_editing_area:
            draft_crop_box = st.session_state.get("select_area_draft_crop_box") or confirmed_crop_box or preset_box
            ...
            if confirmed_crop_box is not None:
                ...
                if st.button(t("select_area_start"), key="select_area_start_button", type="primary"):
                    st.session_state["select_area_editing"] = True
                    st.session_state["select_area_draft_crop_box"] = preset_box
                    try:
                        st.rerun()
                    except Exception:
                        pass
