# crochet_translator_streamlit_v1_7r.py
# Mobile-first Streamlit UI for Crochet Stitch Translator
# Data file expected in same folder: stitches_1_6b.csv
# Optional search index: stitches_1_6d_search_index.csv
...
SOURCE_CSV = BASE_DIR / "stitches_1_8.csv"
SEARCH_INDEX_CSV = BASE_DIR / "stitches_1_8_search_index.csv"
...
def load_data() -> pd.DataFrame:
    ...
    for col in DISPLAY_COLUMNS + SEARCH_COLUMNS + ["symbol_file"]:
...
def render_result_card(row: pd.Series, text: dict) -> None:
    ...
    if symbol_file:
        symbol_path = BASE_DIR / "symbols" / symbol_file
